    ...
    <div class="modal fade" id="gameOverModal_gioco3" tabindex="-1" aria-labelledby="gameOverModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.5);">
                ...
                <form:form id="giocoVO_gioco3" method="POST" action="salvaScore" modelAttribute="partita">
                    ...
                    <button class="btn btn-secondary" type="submit" id="viewLeaderboardButton_gioco3">Vedi il tuo punteggio</button>
                </form:form>
                </div>
            </div>
        </div>
