         ...
         <div class="margini">
            <form:form method="POST" action="add" modelAttribute="utente" class="row g-3 col-md-12" id="formRegistrazione">
                <div class="alert alert-success d-flex align-items-center col-md-6" role="alert" id="registerAlert"
                    style = "margin-left: 160px; display: ${registerOK} !important; margin-top: 30px">
                ...
                <div class="col-md-6">
                    ...
                    <form:errors path="nome" cssClass="error">Inserisci un nome</form:errors>
                </div>
                <div class="col-md-6">
                    ...
                    <form:errors path="cognome" cssClass="error">Inserisci un cognome</form:errors>
                </div>
                <div class="col-md-12">
                    ...
                    <form:errors path="email" cssClass="error">Inserisci una e-mail</form:errors>
                </div>
                <div class="col-md-12">
                    ...
                    <form:errors path="password" cssClass="error">
                        La password deve avere almeno 8 caratteri e contenere almeno una lettera maiuscola,minuscola, numero e carattere speciale
                    </form:errors>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <form:errors path="nazione" cssClass="error">Inserisci una nazione</form:errors>
                </div>
                <div class="col-md-12">
                  ...
                  <form:errors path="telefono" cssClass="error">Inserisci un numero di telefono valido</form:errors>
                </div>
                <div class="col-12" style="margin-top: 20px;">
                    <div class="myTest custom-control custom-checkbox">
                        ...
                        <form:errors path="accettaTermini" cssClass="errorMessage">Devi accettare i termini e le condizioni per proseguire</form:errors>
                    </div>
                </div>
